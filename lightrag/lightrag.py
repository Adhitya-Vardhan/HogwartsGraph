...
PineconeVectorDBStorage = lazy_external_import(".kg.pinecone_impl", "PineconeVectorDBStorage")
...
class LightRAG:
    ...
    def _get_storage_class(self) -> Type[BaseGraphStorage]:
        return {
            ...
            "PineconeVectorDBStorage": PineconeVectorDBStorage,
        ...
        try:
            ...
            for doc_key, doc in tqdm_async(
                ...
                chunks = {
                    ...
                    for dp in chunking_with_page_numbers(
                        doc["content"],
